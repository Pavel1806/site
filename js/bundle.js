   ...
   form.addEventListener('submit', (e)=>{
     ...
     formData.forEach((value, key)=>{
       jsonData[key]=value;
         ...
         (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', JSON.stringify(jsonData))
   .then(result => {
               console.log(result);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addShow": () => (/* binding */ addShow),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "removeShow": () => (/* binding */ removeShow)
/* harmony export */ });
...
document.addEventListener('DOMContentLoaded', ()=>{
  const intervalShowModal = setInterval(()=>{(0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.addShow)(modalSelector, intervalShowModal)}, 3000),
        modalSelector = '.modal';
